...
import { User, Mail, Phone, MapPin, Upload, Camera, Save, Building2, Loader2 } from 'lucide-react';
          ...
          <div className="space-y-3 text-sm text-gray-600">
            ...
            <div className="flex items-center justify-between py-2">
              ...
              <Button
                variant="outline"
                size="sm"
                className="border-[#2D6A4F] text-[#2D6A4F] hover:bg-[#2D6A4F] hover:text-white text-xs"
              >
                {t('profile.enable')}
              </Button>
            </div>
