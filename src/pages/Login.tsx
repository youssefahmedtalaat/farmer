    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="hidden lg:flex relative bg-gradient-to-br from-[#2D6A4F] via-[#95D5B2] to-[#74C0FC] items-center justify-center p-12">
        ...
        <div className="relative z-10 text-white max-w-md">
          ...
          <h2 className="text-white mb-4">Grow Smarter, Not Harder</h2>
          <p className="text-white/90 text-lg mb-8">
            Join thousands of farmers using AI-powered insights to maximize their harvest and
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-white">Track crops and inventory in real-time</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <p className="text-white">Get AI-powered recommendations</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <p className="text-white">Connect with marketplaces instantly</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <Card className="w-full max-w-md p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {!isSignup && (
              ...
              >
                {isCreatingDemo ? 'Setting up Demo...' : 'Use Demo Account'}
              </Button>
            )}
          </form>
